...
function renderCombObraCards(rows){
  ...
  rows.forEach(r=>{
    ...
    const nome=OBRAS.find(o=>o.id===r.obra_id)?.nome||(r.obra_id?r.obra_id:'Sem obra');
...
function _initCombustivelAdmin(){
  ...
  if(selObra){
    ...
    OBRAS.forEach(o=>{const op=document.createElement('option');op.value=o.id;op.textContent=o.nome;selObra.appendChild(op);});
  }
